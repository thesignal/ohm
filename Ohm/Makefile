...
Makefile: Ohm.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d obj/harbour-ohm1.0.0 || mkdir -p obj/harbour-ohm1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/harbour-ohm1.0.0/ && $(COPY_FILE) --parents src/Ohm.cpp obj/harbour-ohm1.0.0/ && (cd `dirname obj/harbour-ohm1.0.0` && $(TAR) harbour-ohm1.0.0.tar harbour-ohm1.0.0 && $(COMPRESS) harbour-ohm1.0.0.tar) && $(MOVE) `dirname obj/harbour-ohm1.0.0`/harbour-ohm1.0.0.tar.gz . && $(DEL_FILE) -r obj/harbour-ohm1.0.0
...
obj/Ohm.o: src/Ohm.cpp /usr/include/qt5/QtQuick/QtQuick \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/Ohm.o src/Ohm.cpp
...
install_icon: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/test/Ohm/Ohm/harbour-ohm.png $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/
	-: $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-ohm.png

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-ohm.png
...
install_desktop: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/test/Ohm/Ohm/harbour-ohm.desktop $(INSTALL_ROOT)/usr/share/applications/
	-: $(INSTALL_ROOT)/usr/share/applications/harbour-ohm.desktop

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/harbour-ohm.desktop
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/applications/ 


install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-ohm || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-ohm
	-$(INSTALL_DIR) /home/mersdk/test/Ohm/Ohm/qml $(INSTALL_ROOT)/usr/share/harbour-ohm/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-ohm/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-ohm/ 
